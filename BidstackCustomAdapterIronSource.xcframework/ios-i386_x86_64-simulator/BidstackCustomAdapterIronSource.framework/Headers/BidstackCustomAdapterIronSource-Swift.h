...
#ifndef BIDSTACKCUSTOMADAPTERIRONSOURCE_SWIFT_H
#define BIDSTACKCUSTOMADAPTERIRONSOURCE_SWIFT_H
...
#endif
@import BidstackMobileAdsSDK;
@import IronSourceSwift;
#endif
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BidstackCustomAdapterIronSource",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("ISBidstackCustomAdapter")
@interface ISBidstackCustomAdapter : ISBaseNetworkAdapter
- (void)init:(ISAdData * _Null_unspecified)adData delegate:(id <ISNetworkInitializationDelegate> _Null_unspecified)delegate SWIFT_METHOD_FAMILY(none);
...
SWIFT_CLASS_NAMED("ISBidstackCustomInterstitial")
...
@class BidstackVASTPlayer;

@interface ISBidstackCustomInterstitial (SWIFT_EXTENSION(BidstackCustomAdapterIronSource)) <BidstackAdPlayerDelegate>
...
SWIFT_CLASS_NAMED("ISBidstackCustomRewardedVideo")
...
@interface ISBidstackCustomRewardedVideo (SWIFT_EXTENSION(BidstackCustomAdapterIronSource)) <BidstackAdPlayerDelegate>
- (void)adDidLoad:(BidstackVASTPlayer * _Nonnull)player;
- (void)adDidClose:(BidstackVASTPlayer * _Nonnull)player;
- (void)adDidOpen:(BidstackVASTPlayer * _Nonnull)player;
- (void)adDidReward:(BidstackVASTPlayer * _Nonnull)player;
